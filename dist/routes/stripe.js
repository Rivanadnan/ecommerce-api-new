...
const stripeController_1 = require("../controllers/stripeController"); // 🔁 OBS: filändelse krävs för ESM/Vercel
const router = express_1.default.Router();
// ✅ Stripe Hosted Checkout – används i frontend
router.post("/checkout-session-hosted", (req, res) => {
    (0, stripeController_1.checkoutSessionHosted)(req, res).catch((err) => {
...
router.post("/embedded", (req, res) => {
    (0, stripeController_1.checkoutSessionEmbedded)(req, res).catch((err) => {
...
router.post("/webhook", (req, res) => {
    (0, stripeController_1.webhook)(req, res).catch((err) => {
